    ...
    <>
      ...
      <div className="h-screen relative overflow-hidden">
        <motion.div
          ...
          style={{
            backgroundImage:
              "url(https://res.cloudinary.com/dbhx39mmm/image/upload/v1773222533/baby-hero_cedp9q.png)",
          }}
      ...
      <div className="bg-white w-full">
        <div className="max-w-[1920px] mx-auto px-16 py-20">
          {/* Title — shared layoutId, teks "Baby Model" dari Photoshoot turun ke sini */}
          <motion.h1
            layoutId="baby-model-title"
